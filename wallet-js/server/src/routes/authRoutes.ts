...
import {
  issueJWT,
  PrivyAuthenticatedRequest,
  privyJwtMiddleware,
} from '../middleware/jwt'
import axios from 'axios'
import config from '../config'
import { createUser, getUserByPrivyId } from '../services/userService'
...
router.get(
  ...
  privyJwtMiddleware,
  asyncHandler(
    async (req: PrivyAuthenticatedRequest, res: express.Response) => {
